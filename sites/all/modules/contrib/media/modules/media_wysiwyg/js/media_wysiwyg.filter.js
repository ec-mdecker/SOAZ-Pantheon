  ...
  Drupal.media.filter = {
    ...
    parseAttributeFields: function(options, includeFieldID) {
      ...
      for (var field in options) {
        ...
        if (field.match(/^field_alt_text/)){
          attributes.linkText = options[field];
          if(includeFieldID){
            attributes.linkText = field;
          }
        }
      }
    ...
    syncAttributesToFields: function(file_info) {
      ...
      // If the alt attribute has changed, ensure the alt field is updated.
      var link = file_info.fields[fields.linkText] || false;
      if (fields.linkText && (link !== fields.linkText)) {
        file_info.fields[fields.linkText] = link;
      }
